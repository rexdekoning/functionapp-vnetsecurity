...
>**Note**: To reference the module, please use the following syntax `./packages/p2s-vpn-gateway/main.bicep`.
...
```bicep
module p2sVpnGateway './packages/p2s-vpn-gateway/main.bicep' = {
...
```bicep-params
using './packages/p2s-vpn-gateway/main.bicep'
