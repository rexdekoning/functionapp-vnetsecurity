...
metadata publishedOn = '2024-10-25T09:55:26Z'
...
module publicIPAddress './packages/public-ip-addresses/main.bicep' = if (empty(bastionSubnetPublicIpResourceId) && (!enablePrivateOnlyBastion)) {
