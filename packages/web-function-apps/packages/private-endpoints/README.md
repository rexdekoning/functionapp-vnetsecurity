...
>**Note**: To reference the module, please use the following syntax `./packages/private-endpoints/main.bicep`.
...
```bicep
module privateEndpoint './packages/private-endpoints/main.bicep' = {
