...
>**Note**: To reference the module, please use the following syntax `./packages/public-ip-addresses/main.bicep`.
...
```bicep
module publicIpAddress './packages/public-ip-addresses/main.bicep' = {
