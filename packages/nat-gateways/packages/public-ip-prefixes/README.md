...
>**Note**: To reference the module, please use the following syntax `./packages/public-ip-prefixes/main.bicep`.
...
```bicep
module publicIpPrefix './packages/public-ip-prefixes/main.bicep' = {
