...
>**Note**: To reference the module, please use the following syntax `./packages/nat-gateways/main.bicep`.
...
```bicep
module natGateway './packages/nat-gateways/main.bicep' = {
...
```bicep-params
using './packages/nat-gateways/main.bicep'
...
| Reference | Type |
| :-- | :-- |
| `./packages/public-ip-addresses/main.bicep` | Local Reference |
| `./packages/public-ip-prefixes/main.bicep` | Local Reference |
