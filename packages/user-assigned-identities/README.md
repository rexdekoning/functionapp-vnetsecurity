...
>**Note**: To reference the module, please use the following syntax `./packages/user-assigned-identities/main.bicep`.
...
```bicep
module userAssignedIdentity './packages/user-assigned-identities/main.bicep' = {
