...
>**Note**: To reference the module, please use the following syntax `./packages/ops-management-solution/main.bicep`.
...
```bicep
module solution './packages/ops-management-solution/main.bicep' = {
...
```bicep-params
using './packages/ops-management-solution/main.bicep'
