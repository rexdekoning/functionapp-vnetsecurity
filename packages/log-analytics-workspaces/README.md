...
>**Note**: To reference the module, please use the following syntax `./packages/log-analytics-workspaces/main.bicep`.
...
```bicep
module workspace './packages/log-analytics-workspaces/main.bicep' = {
