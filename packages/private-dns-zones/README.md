...
>**Note**: To reference the module, please use the following syntax `./packages/private-dns-zones/main.bicep`.
...
```bicep
module privateDnsZone './packages/private-dns-zones/main.bicep' = {
