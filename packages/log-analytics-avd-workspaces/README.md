...
>**Note**: To reference the module, please use the following syntax `./packages/log-analytics-avd-workspaces/main.bicep`.
...
```bicep
module workspace './packages/log-analytics-avd-workspaces/main.bicep' = {
...
| Reference | Type |
| :-- | :-- |
| `./packages/ops-management-solution/main.bicep` | Local Reference |
