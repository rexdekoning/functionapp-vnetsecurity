...
metadata publishedOn = '2024-11-18T05:23:42Z'
...
import { managedIdentityAllType } from './packages/utl-common-types/main.bicep'
...
import { lockType } from './packages/utl-common-types/main.bicep'
@description('Optional. The lock settings of the service.')
param lock lockType?

import { roleAssignmentType } from './packages/utl-common-types/main.bicep'
...
module logAnalyticsWorkspace_solutions './packages/ops-management-solution/main.bicep' = [
...
import { solutionPlanType } from './packages/ops-management-solution/main.bicep'
