...
>**Note**: To reference the module, please use the following syntax `./packages/private-link-services/main.bicep`.
...
```bicep
module privateLinkService './packages/private-link-services/main.bicep' = {
...
```bicep-params
using './packages/private-link-services/main.bicep'
