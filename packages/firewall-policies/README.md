...
>**Note**: To reference the module, please use the following syntax `./packages/firewall-policies/main.bicep`.
...
```bicep
module firewallPolicy './packages/firewall-policies/main.bicep' = {
