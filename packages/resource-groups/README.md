...
>**Note**: To reference the module, please use the following syntax `./packages/resource-groups/main.bicep`.
...
```bicep
module resourceGroup './packages/resource-groups/main.bicep' = {
