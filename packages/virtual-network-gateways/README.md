...
>**Note**: To reference the module, please use the following syntax `./packages/virtual-network-gateways/main.bicep`.
...
```bicep
module virtualNetworkGateway './packages/virtual-network-gateways/main.bicep' = {
