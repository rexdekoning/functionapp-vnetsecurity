...
>**Note**: To reference the module, please use the following syntax `./packages/storage-accounts/main.bicep`.
...
```bicep
module storageAccount './packages/storage-accounts/main.bicep' = {
...
| `./packages/utl-common-types/0.4.0/main.bicep` | Local Reference |
