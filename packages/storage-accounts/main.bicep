...
metadata publishedOn = '2024-12-12T16:24:52Z'
...
import { roleAssignmentType } from './packages/utl-common-types/0.4.0/main.bicep'
@description('Optional. Array of role assignments to create.')
param roleAssignments roleAssignmentType[]?

import { managedIdentityAllType } from './packages/utl-common-types/0.4.0/main.bicep'
...
import { privateEndpointMultiServiceType } from './packages/utl-common-types/0.4.0/main.bicep'
...
import { diagnosticSettingFullType } from './packages/utl-common-types/0.4.0/main.bicep'
@description('Optional. The diagnostic settings of the service.')
param diagnosticSettings diagnosticSettingFullType[]?

import { lockType } from './packages/utl-common-types/0.4.0/main.bicep'
...
import { customerManagedKeyWithAutoRotateType } from './packages/utl-common-types/0.4.0/main.bicep'
...
module storageAccount_privateEndpoints './packages/private-endpoints/main.bicep' = [
...
import { secretsOutputType } from './packages/utl-common-types/0.2.1/main.bicep'
