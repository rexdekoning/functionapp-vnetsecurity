...
>**Note**: To reference the module, please use the following syntax `./packages/utl-common-types/main.bicep`.
...
import {
  ...
  secretToSetType
  secretSetOutputType
} from '../../../main.bicep' // Would be: ./packages/utl-common-types/main.bicep
