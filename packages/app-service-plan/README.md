...
>**Note**: To reference the module, please use the following syntax `./packages/app-service-plan/main.bicep`.
...
```bicep
module serverfarm './packages/app-service-plan/main.bicep' = {
