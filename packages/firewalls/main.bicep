...
metadata publishedOn = '2024-10-11T06:57:40Z'
...
module publicIPAddress './packages/public-ip-addresses/main.bicep' = if (empty(publicIPResourceID) && azureSkuName == 'AZFW_VNet') {
...
module managementIPAddress './packages/public-ip-addresses/main.bicep' = if (isCreateDefaultManagementIP && azureSkuName == 'AZFW_VNet') {
